...
assert.match(copilotUiCode, /parseCopilotAnswerSections/, 'CostPage should have section parser for copilot answers')
assert.match(copilotUiCode, /\[A-Za-z가-힣\]/, 'CostPage section parser should recognize Korean heading labels')
