...
scripts/public_beta_contract_smoke.sh  # public beta contract completeness smoke
scripts/hosted_e2e_preflight_contract_smoke.sh  # hosted E2E preflight contract smoke
```
