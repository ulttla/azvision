...
- **2026-04-22 same-line UX follow-up**
  ...
  - server save-after warning copy도 `server validation or thumbnail guard checks` 기준으로 정렬했고, `scripts/snapshot_thumbnail_guard_copy_smoke.mts` 로 guide/warning copy drift를 빠르게 smoke 가능하게 정리
