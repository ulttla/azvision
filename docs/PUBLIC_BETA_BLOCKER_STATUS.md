...
1. G1 auth/workspace isolation OIDC workspace mapping/account lifecycle is wired behind the tested `/auth/oidc/session` entrypoint and session lookup/issuance/revocation seam.
