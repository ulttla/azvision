...
- `docs/HOSTED_E2E_PREFLIGHT_PLAN.md` defines the private hosted browser/API smoke required before any public exposure; `scripts/hosted_public_beta_smoke.mjs` is the fail-closed skeleton.
